...
if( NACL )
  add_custom_command( OUTPUT openzone.nmf openzone.html
    ...
    COMMAND \${CMAKE_COMMAND} -E copy_if_different "\${CMAKE_SOURCE_DIR}/etc/nacl/openzone.nmf" openzone.nmf
    COMMAND \${CMAKE_COMMAND} -E copy_if_different "\${CMAKE_SOURCE_DIR}/etc/nacl/openzone.html" openzone.html )
