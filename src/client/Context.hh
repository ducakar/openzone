...
class Context
{
  ...
  private:
    ...
    Hashtable<int, ContSource>    contSources;     // looping sources
    ...
    Hashtable<int, Imago*, 10223> imagines;        // currently loaded graphics models
    Hashtable<int, Audio*, 6143>  audios;          // currently loaded audio models
