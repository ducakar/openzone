...
namespace oz
{
  ...
  ObjectClass* VehicleClass::init( const String& name, const Config* config )
  {
    ...
    clazz->crewPos[Vehicle::PILOT] = Vec4( config->get( "crew.pilot.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::GUNNER] = Vec4( config->get( "crew.gunner.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::COMMANDER] = Vec4( config->get( "crew.commander.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::PASSENGER0] = Vec4( config->get( "crew.passenger0.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::PASSENGER1] = Vec4( config->get( "crew.passenger1.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::PASSENGER2] = Vec4( config->get( "crew.passenger2.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::PASSENGER3] = Vec4( config->get( "crew.passenger3.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::PASSENGER4] = Vec4( config->get( "crew.passenger4.pos.x", 0.0f ),
    ...
    clazz->crewPos[Vehicle::PASSENGER5] = Vec4( config->get( "crew.passenger5.pos.x", 0.0f ),
  ...
  Object* VehicleClass::create( int index, const Vec4& pos ) const
  {
