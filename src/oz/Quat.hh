...
namespace oz
{
  ...
  class Quat : public Vec3
  {
    public:
      ...
      // make rotation matrix (implemented in Mat33.hh)
      Mat33 rotMat33() const;

      // make transposed (inverse) rotation matrix (implemented in Mat33.hh)
      Mat33 invRotMat33() const;

      // make rotation matrix (implemented in Mat44.hh)
      Mat44 rotMat44() const;

      // make transposed (inverse) rotation matrix (implemented in Mat44.hh)
