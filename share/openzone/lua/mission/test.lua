...
function onCreate()
  ...
  ozOrbisAddStr( "castle", 143, 0, 79, OZ_STRUCT_R0 )
  ozOrbisAddStr( "pool", 112, -7, 70, OZ_STRUCT_R0 )
  ozOrbisAddStr( "tower", 106, -7, 75, OZ_STRUCT_R90 )

  ozOrbisAddObj( "serviceStation", 110, -25, 68.8 )
